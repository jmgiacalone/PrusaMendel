...
layer_thickness=0.3;
filament_feed_hole_d=3.5;//2.3;
filament_diameter=3;//1.75;
filament_feed_hole_offset=m8_diameter/2+filament_diameter/2-0.5;//filament_diameter+3.5;
...
module mendel_parts_v6_hotend () 
{
	...
	hole_separation=30;
	hole_slot_height=8;
	trap_height=base_thickness/2-2;
